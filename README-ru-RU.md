...
#### В: Почему лимит составляет 142 игры?

О: Поскольку GreenLuma не является открытым исходным кодом (по крайней мере, я не смог найти его исходный код), максимум в 142 разблокировки - это жестко заданный лимит, установленный автором. Причина может быть в том, что GreenLuma нужно подменить ID вашей игры, чтобы обойти проверку Steam, но автор нашел только 142 бесплатные игры (доступные всем), которые можно использовать для замены.
