...
namespace CN_GreenLumaGUI.ViewModels
{
    public partial class ManagerViewModel : ObservableObject
    {
        ...
        private async Task StartSteamNormal()
        {
            ...
            steamProcess.StartInfo.Arguments = DataSystem.Instance.SkipSteamUpdate ? "-noverifyfiles -nobootstrapupdate -skipinitialbootstrap -norepairfiles -overridepackageurl" : "-test";
